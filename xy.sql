...
-- 数据库: `xy`
--
CREATE DATABASE IF NOT EXISTS `xy` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `xy`;
...
CREATE TABLE IF NOT EXISTS `dy_group` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='分组表' AUTO_INCREMENT=5 ;

--
-- 转存表中的数据 `dy_group`
--

INSERT INTO `dy_group` (`id`, `title`, `type`, `createTime`, `lastTime`, `status`, `sort`, `remark`) VALUES
(1, '测试期分组', 1, 0, 0, 1, NULL, '1为博客'),
(2, '测试分组2', 1, 0, 0, 1, NULL, ''),
(3, '共享分组1', 2, 0, 0, 1, NULL, '2共享'),
(4, '项目分组', 3, 0, 0, 1, NULL, '3为项目分组');
...
(3, 'comment', 'Home', 'Comment', 'index', '留言', 0, 0, 1, 4, 0, 2, '留言'),
(4, 'comment', 'Admin', 'Comment', 'index', '留言管理', 0, 0, 1, 0, 0, 1, '后台留言管理'),
(5, 'Seting', 'Admin', 'Seting', 'index', '博客配置', 0, 0, 1, 0, 0, 1, '后台导航'),
(6, 'Share', 'Home', 'Share', 'index', '共享', 0, 0, 1, 2, 0, 2, '首页导航'),
...
(1, 'admin', '管理员', 'abb7d91718e42a0508c97d8ebc208d91', 1, 1373772381, '127.0.0.1', 77, '614422099@qq.com', 614422099, '', 1362651445, '127.0.0.1', 0, 1),
(2, 'test', '测试', 'e10adc3949ba59abbe56e057f20f883e', 1, 1372267419, '127.0.0.1', 88, 'xyblog@dingxiaoyu.com', 0, '', 0, NULL, 1372267245, 1),

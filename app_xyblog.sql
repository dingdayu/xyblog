...
--
-- Host: 127.0.0.1
-- Generation Time: 2015-11-19 17:38:32
...
CREATE TABLE IF NOT EXISTS `dy_blogs` (
  ...
  `category` varchar(60) DEFAULT NULL COMMENT '分组名称',
